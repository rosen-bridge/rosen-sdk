...
The RosenChain SDK (`rosen-sdk`) provides a set of tools and functions to interact with multiple blockchains, including Ergo, Cardano. This SDK enables developers to utilize Rosen-Bridge as an underlying technology to transfer assets between blockchain networks.
